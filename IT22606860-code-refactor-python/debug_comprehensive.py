...
print('INITIAL CODE LENGTH:', len(code))
print()
...
code3 = r3.get('refactored_code', code)
print(f'Issues: {len(r3.get("issues", []))}')
print(f'Changes: {r3.get("changes_applied", [])}')
print(f'Code changed: {code != code3}')
for i in r3.get('issues', []):
    print(f'  {i.risk_type} @ line {i.line}')
code = code3
...
code4 = r4.get('optimized_code', code)
print(f'Issues: {len(r4.get("issues", []))}')
print(f'Changes: {r4.get("changes_applied", [])}')
print(f'Code changed: {code != code4}')
for i in r4.get('issues', []):
    print(f'  {i.issue_type} @ line {i.line}')
code = code4
